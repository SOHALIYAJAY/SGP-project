  ...
  const handleNext = async () => {
    ...
    try {
      ...
      if (typeof window !== "undefined") {
        sessionStorage.setItem("baps:analysis", JSON.stringify(analysis))
      }
      ...
      setError(
        "Could not generate analysis. Please ensure your dataset files exist and try again."
      )
    } finally {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="form-card-glow rounded-2xl p-6 md:p-8 opacity-0 animate-fade-in-up stagger-2">
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-border">
            ...
            {error && (
              <p className="mt-4 text-xs text-destructive text-right w-full">
                {error}
              </p>
            )}
          </div>
