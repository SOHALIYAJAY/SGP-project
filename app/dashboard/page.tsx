    ...
    <div className="min-h-screen py-2">
      <SectionWrapper>
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 bg-card border border-border rounded-xl p-6 opacity-0 animate-fade-in-up stagger-5">
          ...
          <div className="bg-card border border-border rounded-xl p-6 opacity-0 animate-fade-in-up stagger-6">
            <div className="flex items-start justify-between gap-4 mb-2">
              ...
              <ChartInsight
                ...
                bullets={["70% stable/active customers", "20% at-risk — engage soon", "10% churned — analyze why"]}
              />
            </div>
            <p className="text-sm text-muted-foreground mb-4">
        ...
        <div className="bg-card border border-border rounded-xl p-6 opacity-0 animate-fade-in-up stagger-5 mb-8">
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-card-foreground">
              Risk Distribution
            </h3>
...
function InsightCard({
  ...
  return (
    <div
      className={`bg-card border border-border border-l-4 ${style.border} rounded-xl p-6 card-hover opacity-0 animate-fade-in-up hover:${style.glow}`}
