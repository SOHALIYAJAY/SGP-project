  ...
  return (
    <div className="min-h-screen pt-20">
      <SectionWrapper>
        ...
        <div className="bg-card border border-border rounded-xl p-6 mb-12 opacity-0 animate-fade-in-up stagger-6">
...
function RiskFlagCard({
  ...
  return (
    <div
      className={`bg-card border border-border border-l-4 ${style.border} rounded-xl p-6 card-hover opacity-0 animate-fade-in-up`}
