...
export default function FinancialAnalysisPage() {
  ...
  const annualRevenueM = (analysis?.financial.annualRevenue ?? 8200000) / 1_000_000
  const burnRateK = (analysis?.financial.burnRateMonthly ?? 180000) / 1000
  return (
      ...
      <SectionWrapper>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <MetricCard
            ...
            value={`$${annualRevenueM.toFixed(1)}M`}
          ...
          <MetricCard
            title="Profit Margin"
            value={`${analysis?.financial.profitMarginPercent ?? 22}%`}
          ...
          <MetricCard
            title="Runway"
            value={`${analysis?.financial.runwayMonths ?? 18} mo`}
