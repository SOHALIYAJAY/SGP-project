...
const capTable = [
  { name: "Founders", value: 55, color: "#06B6D4" },
  { name: "Series A", value: 20, color: "#22C55E" },
  { name: "Seed", value: 12, color: "#F59E0B" },
  { name: "ESOP", value: 10, color: "#22D3EE" },
  { name: "Advisors", value: 3, color: "#64748B" },
]
  ...
  return (
    <div className="min-h-screen py-2">
      <SectionWrapper>
        ...
        <div className="bg-card border border-border border-t-[3px] border-t-success rounded-xl p-6 mb-8 opacity-0 animate-fade-in-up stagger-6">
