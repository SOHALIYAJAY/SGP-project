    ...
    <div className="min-h-screen py-2">
      <SectionWrapper>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 items-stretch">
          <MetricCard
            title="Market Size"
            value={`$${analysis?.market.marketSizeB ?? 50}B`}
          ...
          <MetricCard
            title="Competition"
            value={(analysis?.market.competitorCount ?? 15) > 25 ? "High" : (analysis?.market.competitorCount ?? 15) > 10 ? "Medium" : "Low"}
            subtitle={`${analysis?.market.competitorCount ?? 15} major players`}
            icon={Users}
            status="warning"
            delay={200}
          ...
          <MetricCard
            title="Opportunity"
            value={`${analysis?.market.opportunityScore ?? 87}/100`}
          ...
          <MetricCard
            title="Growth Rate"
            value={`+${analysis?.market.growthRatePercent ?? 24}%`}
