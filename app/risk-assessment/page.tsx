    ...
    <div className="min-h-screen py-2">
      <SectionWrapper>
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-8">
          {/* Risk Gauge */}
          <div className="bg-card border border-border rounded-xl p-6 opacity-0 animate-fade-in-up stagger-1">
          ...
          {/* Risk Radar Chart */}
          <div className="bg-card border border-border rounded-xl p-6 opacity-0 animate-fade-in-up stagger-2">
          ...
          {/* Risk Summary */}
          <div className="bg-card border border-border rounded-xl p-6 opacity-0 animate-fade-in-up stagger-3">
            <div className="flex items-start justify-between gap-4 mb-2">
              <h3 className="text-lg font-semibold text-card-foreground">
                Risk Summary
              </h3>
        ...
        {/* Risk Trend Chart */}
        <div className="bg-card border border-border rounded-xl p-6 mb-8 opacity-0 animate-fade-in-up stagger-4">
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={riskTrend}>
                ...
                />
                <Line type="monotone" dataKey="overall" name="Overall" stroke="#F59E0B" strokeWidth={3} dot={{ fill: "#F59E0B", r: 4 }} />
                <Line type="monotone" dataKey="financial" name="Financial" stroke="#06B6D4" strokeWidth={2} dot={{ fill: "#06B6D4", r: 3 }} />
                <Line type="monotone" dataKey="market" name="Market" stroke="#EF4444" strokeWidth={2} dot={{ fill: "#EF4444", r: 3 }} />
                <Line type="monotone" dataKey="operational" name="Operational" stroke="#22C55E" strokeWidth={2} dot={{ fill: "#22C55E", r: 3 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        {/* Mitigation Actions */}
        <div className="bg-card border border-border rounded-xl p-6 mb-8 opacity-0 animate-fade-in-up stagger-6">
...
function RiskCategoryCard({
  ...
  return (
    <div
      className={`bg-card border border-border border-t-[3px] ${style.border} rounded-xl p-6 card-hover opacity-0 animate-fade-in-up`}
