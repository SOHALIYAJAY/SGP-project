...
export default function RiskAssessmentPage() {
  ...
  const overallRiskScore =
    analysis?.risk.overallRiskScore ??
    Math.round(riskCategories.reduce((sum, cat) => sum + cat.score, 0) / riskCategories.length)
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-lg font-semibold text-card-foreground">
                  {overallRiskScore >= 55 ? "High Risk Profile" : overallRiskScore >= 30 ? "Medium Risk Profile" : "Low Risk Profile"}
                </h3>
              </div>
              <p className="text-sm text-muted-foreground text-center">
                {analysis
                  ? `Model-driven risk score from your submitted company data.`
