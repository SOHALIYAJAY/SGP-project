...
const techStack = [
  { category: "Frontend", technologies: ["React 18", "TypeScript", "Tailwind CSS", "Recharts", "Lucide Icons"] },
  { category: "UI Components", technologies: ["shadcn/ui", "Radix UI", "React Router", "Sonner Toast"] },
  { category: "Build Tools", technologies: ["Vite", "ESLint", "PostCSS"] },
  { category: "Analysis (Conceptual)", technologies: ["Python", "Scikit-learn", "Pandas", "NumPy"] },
];

const teamMembers = [
  { name: "Student Name 1", role: "Project Lead & Frontend Developer" },
  { name: "Student Name 2", role: "UI/UX Designer & Developer" },
  { name: "Student Name 3", role: "Data Analysis & Documentation" },
  { name: "Student Name 4", role: "Testing & Quality Assurance" },
];
      ...
      <div className="space-y-6">
        ...
        <div className="glass-card p-6">
          <SectionHeader
            ...
            subtitle="Addressing key challenges in business analysis"
            icon={Target}
          />
          <div className="p-4 rounded-lg bg-warning/10 border border-warning/20">
            <p className="text-sm text-muted-foreground">
              Traditional business analysis methods are often time-consuming, require specialized 
              expertise, and may not provide comprehensive insights across all business dimensions. 
              Decision-makers need a unified platform that can quickly assess business health, 
              predict future performance, identify risks, and provide actionable recommendations 
              ...
              <div key={index}>
                ...
                <div className="space-y-2">
                  {stack.technologies.map((tech, idx) => (
                    <div
                      key={idx}
                      className="px-3 py-1.5 text-sm rounded-md bg-secondary/50 border border-border"
                    >
                      {tech}
                    </div>
                  ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="glass-card p-6">
            <SectionHeader
              title="Project Team"
              subtitle="Contributors and roles"
              icon={Users}
            />
